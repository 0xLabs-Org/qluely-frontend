      ...
      >
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="flex flex-col gap-4 text-balance">
            <p className="text-lg">
              Yes. Qluely runs locally on your device and does not inject bots,
              overlays, or plugins into your meetings. Nothing appears inside
              Zoom, Teams, or Google Meet. Other participants cannot detect
              Qluely.
            </p>
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="flex flex-col gap-4 text-balance">
            <p className="text-lg">
              Only when you choose to. All processing happens privately on your
              device. Your data is never shared with meeting participants or
              third parties.
            </p>
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4">
          ...
          <AccordionContent className="flex flex-col gap-4 text-balance">
            <p className="text-lg">
              Yes. Qluely is widely used for job interviews, sales calls, and
              client meetings.
            </p>
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-5">
          ...
          <AccordionContent className="flex flex-col gap-4 text-balance">
            <p className="text-lg">
              Yes. You can share images and reference documents to get smarter
              real-time answers.
            </p>
          </AccordionContent>
        </AccordionItem>
