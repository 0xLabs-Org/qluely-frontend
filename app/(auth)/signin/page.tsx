  ...
  return (
    <form method="post" action="/api/auth/login" style={{ marginTop: 18 }}>
      ...
      <label style={{ display: "block", marginBottom: 10 }}>
        <span style={{ display: "block", marginBottom: 6, color: "#333" }}>
          Email
        </span>
        <input
          name="email"
      ...
      >
        ...
        >
          ...
          <p style={{ color: "rgba(255,255,255,0.8)", marginTop: 10 }}>
            Faster syncs, advanced reports, priority support — one simple
            upgrade.
          </p>
          ...
          <div style={{ marginTop: 28 }}>
            ...
            <p style={{ marginTop: 6, color: "rgba(255,255,255,0.8)" }}>
              Sign in with your email to continue to checkout.
            </p>
          </div>
        </aside>
        ...
        >
          <div style={{ textAlign: "center", marginBottom: 12 }}>
            ...
            <p style={{ margin: 0, color: "#666" }}>
              Enter your email and we'll sign you in or create an account.
            </p>
          </div>
          ...
          >
            ...
            <a href="/terms" style={{ color: "#0b74ff" }}>
              Terms
            </a>{" "}
            and{" "}
            <a href="/privacy" style={{ color: "#0b74ff" }}>
              Privacy Policy
            </a>
            .
          </p>
